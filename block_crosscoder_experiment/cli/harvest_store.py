...
def main() -> None:
    ...
    parser.add_argument("--whitener-tokens", type=int, default=5_000_000)
    parser.add_argument("--calib-tokens", type=int, default=13_000_000)
    parser.add_argument("--eval-tokens", type=int, default=2_000_000)
    parser.add_argument(
        "--train-tokens", type=int, default=38_000_000,
        help="production training split size",
    )
