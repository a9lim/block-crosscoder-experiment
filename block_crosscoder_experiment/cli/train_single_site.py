"""Train the factorial's matched single-site block or scalar cells.
...
Defaults match the production joint operating point.
"""
...
def main() -> None:
    ...
    parser.add_argument("--calib-batches", type=int, default=None,
                        help="optional cap; default streams the full split")
    ...
    for L in sites:
        ...
        available = calib.n_tokens // BATCH
        n_calib = available if args.calib_batches is None else min(
            args.calib_batches, available
        )
