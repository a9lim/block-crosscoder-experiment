"""Extract winner-scoped decoder, encoder, and cross-site geometry.
...
By default this follows ``data/winner.json`` and extracts the promoted winner
plus its matched primary-gauge counterpart into the winner analysis cache.
"""
