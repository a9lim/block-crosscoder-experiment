...
individually and never averaged.

  bsc fig-rd-frontier --inputs data/evidence/rd_*.json \
      data/evidence/f_*.json data/evidence/s_*.json \
      --out figures/summary/rate-distortion.png
"""
...
def main() -> None:
    ...
    ax.set_title("Phase-0 R-D plane — frozen codec "
